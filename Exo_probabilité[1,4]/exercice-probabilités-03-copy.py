...
print(f"Il y a {percentage:.0f} % de chance d'avoir pile & pile")
# exo 3.2
...
print(f"Il y a {percentage:.0f} % de chance d'avoir pile & pile sur les deux premiers lancers")
# exo 3.3
...
# réponse 3.3
# Les différentes issues gagnaites possibles pour Alice:
# 1. pile & pile & pile
# 2. face & pile & pile
# 3. pile & face & pile
# 4. pile & pile & face
...
print(f"Il y a {percentage:.0f} % de chance d'avoir au moins 2 fois piles avec 3 lancers")
